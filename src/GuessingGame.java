    ...
    public static void main(String[] args) {
        ...
        while (userInput != answer) {
            if (userInput > answer) {
                ...
                System.out.println("Your answer is too larger");
                System.out.println("Please enter you guess in the range from " + lowerBound+ "-" + upperBound);
                ...
                System.out.println("Please enter you guess in the range from " + lowerBound+ "-" + upperBound);
                System.out.println("This is your " + numOfTrial + " try");
        System.out.println("Congrats, you got the answer with " + numOfTrial + " attempt");
        }
    }
